...
public class Persistence {
	...
	// Constructor for use with environment variables (for Docker deployments)
	public Persistence() {
		String connString = System.getenv("DB_URI");
		String dbName = System.getenv("DB_NAME");
		String collection = System.getenv("DB_COLLECTION");
	...
	// Constructor for manual injection (e.g., from Spring @PostConstruct)
	public Persistence(String connString, String dbName, String collectionName) {
	...
	// The rest of the methods (getAllRecipes, addRecipes, etc.) stay unchanged...
}
